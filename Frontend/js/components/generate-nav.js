$(function () {
    ...
    bar +='            </svg>'
    bar +='            <span class="link-text">E-Library</span>'
    bar +='        </a>'
    bar +='    </li>'
    ...
    bar +='                </g>   '             
    bar +='                </svg>'
    bar +='            <span class="link-text">Catalogue</span>'
    bar +='        </a>'
    bar +='    </li>'
    bar +='    <li class="nav-item">'
    bar +='        <a href="library.html" class="nav-link">'
    ...
    bar +='                </g>'
    bar +='            </svg>'
    bar +='            <span class="link-text">Library</span>'
    bar +='        </a>'
    bar +='    </li>'
    bar +='    <li class="nav-item">'
    ...
    bar +='                </g>  '                 
    bar +='            </svg>'
    bar +='            <span class="link-text">Log in</span>'
    bar +='        </a>'
    bar +='    </li>'
    bar +='    <li class="nav-item">'
    bar +='        <a href="#" class="nav-link">'
    ...
    bar +='                </g>'
    bar +='            </svg>'
    bar +='            <span class="link-text">Sign up</span>'
    bar +='        </a>'
    bar +='    </li>'
    bar +=' </ul>'
    bar +=' </nav>'
	...
	bar +='			<h4 class="modal-title">Member Login</h4>'
	...
	bar +='					<input type="text" class="form-control" placeholder="Username" required="required">'
	bar +='				</div>'
	bar +='				<div class="form-group">'
	bar +='					<i class="fa fa-lock"></i>'
	bar +='					<input type="password" class="form-control" placeholder="Password" required="required">	'				
	bar +='				</div>'
	bar +='				<div class="form-group">'
	bar +='					<input type="submit" class="btn btn-primary btn-block btn-lg" value="Login">'
	bar +='				</div>'
	bar +='			</form>'
	bar +='		</div>'
	bar +='		<div class="modal-footer">'
	bar +='			<a href="#">Don\'t have an account? Sign up</a>'
	bar +='		</div>'
	bar +='	</div>'
	bar +='</div>'
    bar +='</div>'
